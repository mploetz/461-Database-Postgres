...
\echo '1) A)'
SELECT (SELECT * FROM A EXCEPT SELECT * FROM B) AS AMB, (SELECT * FROM B EXCEPT SELECT * FROM A) AS BMA,
(SELECT * FROM A INTERSECT SELECT * FROM B) AS AINB FROM A, B;
